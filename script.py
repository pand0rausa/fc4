...
/usr/bin/ndisasm -b 32 /tmp/shellcode > /tmp/shellcode.asm 
/bin/sed -i 's/^............................//' /tmp/shellcode.asm 
/bin/sed -i '1 i\_start\:' /tmp/shellcode.asm 
/bin/sed -i '1 i\global \_start' /tmp/shellcode.asm 
/bin/sed -i "/lodsb/i password:" /tmp/shellcode.asm
/bin/sed -i 's/loop 0xb9/loop password/g' /tmp/shellcode.asm 
/usr/bin/nasm -f elf /tmp/shellcode.asm -g 
/usr/bin/ld -o key shellcode.o
